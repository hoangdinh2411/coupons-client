...
async function CouponPage() {
  return (
    <div className="container mx-auto w-full max-w-[1280px] p-8">
      <h2 className="mb-4 text-2xl font-bold sm:text-2xl">
        Top Coupons & Deals Categories
      </h2>
      <div className="my-9 pb-9 flex flex-wrap items-center gap-1 gap-y-4  border-b-1 border-solid border-gray-200">
      ...
      <h2 className="text-[20px] font-[900] sm:text-2xl mb-4">
