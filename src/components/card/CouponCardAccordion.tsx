      ...
      >
        <div className="text-green col-start-1 row-span-3 row-start-1 mx-0 flex w-fit flex-col self-center text-center text-xl font-extrabold tracking-tight uppercase sm:row-span-3 sm:row-start-1 sm:mx-auto sm:pt-1 sm:pb-2 md:mx-0 md:text-3xl lg:tracking-wide">
          <p className="leading-none">
            25%
            <span className="font-proxima ml-1 block font-light underline">
              Log&nbsp;In
            </span>
          </p>
        ...
        <div className="flex w-full justify-between">
          ...
          <button className="bg-green relative mb-2 hidden h-12 !w-[192px] items-center justify-center overflow-hidden rounded-3xl text-base leading-none font-[800] tracking-wider text-white before:absolute before:-top-3 before:-right-5 before:z-10 before:h-8 before:w-12 before:rotate-45 before:bg-gray-300 after:absolute after:-top-4 after:-right-4 after:h-12 after:w-12 after:rotate-45 after:rounded-full after:bg-gray-200/30 md:block">
            Show code
          </button>
        </div>
      </Link>
