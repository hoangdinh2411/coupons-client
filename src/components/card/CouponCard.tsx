...
function CouponCard(props: CouponCardPropsType) {
  ...
  return (
    <button
      className={` ${className} focus:border-green relative flex w-full cursor-pointer gap-2 rounded-xl bg-white text-left focus:border-2 md:h-auto md:flex-col md:border-1 md:border-gray-300 lg:min-h-[278px]`}
      {...rest}
    >
